//
// kernel.h — the Circle kernel that hosts NXEngine-evo.
//
// Device ownership: this kernel brings up interrupts, the timer, a serial
// console carrying stdio, the SD card (FatFs, holding the engine's data
// directory and the player's saved games), the USB host controller and the
...
//   core 1   the APPLICATION core. The game, alone: the main loop and
...
private:
    ...
    // engine opens — reaches the card through it without anything above
